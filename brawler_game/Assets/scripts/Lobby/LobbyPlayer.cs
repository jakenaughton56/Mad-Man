...
namespace UnityStandardAssets.Network
{
    ...
    public class LobbyPlayer : NetworkLobbyPlayer
    {
        ...
        public override void OnClientEnterLobby()
        {
			...
			// change the player's name on the server to be their saved name
			CmdNameChanged (PlayerPrefs.GetString("Name"));
            LobbyPlayerList._instance.AddPlayer(this);
			// another player has entered the game
			int numPlayers = PlayerPrefs.GetInt ("NumPlayersInGame");
			numPlayers++;
			PlayerPrefs.SetInt ("NumPlayersInGame", numPlayers);
        ...
        void SetupLocalPlayer()
        {
			...
			// players should not be able to change their name
            nameInput.interactable = false;
